    ...
    return (
      <div className="min-h-[calc(100vh-100px)] flex justify-center items-center p-8 box-border text-center">
        <div className="bg-white p-12 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] animate-[scaleIn_0.4s_ease-out] w-full max-w-[480px]">
          <h1 className="text-[#1a1a1a] mb-2 text-[1.5rem] font-bold mt-0">3️⃣ Claim Your Offer</h1>
          <p className="text-gray-500 text-lg mb-6">Your exclusive reward unlocks instantly on Clozzet.</p>
          <p className="text-gray-500 text-sm mb-6">Use the code given below to redeem your Luck</p>
  ...
  return (
    <div className="min-h-[calc(100vh-100px)] flex justify-center items-center p-8 box-border">
      <div className="bg-white p-6 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] w-full max-w-[480px] text-left animate-[slideUp_0.6s_ease-out]">
        {/* <h1 className="text-[1.75rem] text-[#1a1a1a] mb-2 font-bold mt-0">You’ve unlocked a limited Clozzet Offer Hunt reward from your favorite store.
          Fill in your details and claim it instantly.</h1> */}
        <p className="text-[#1a1a1a] mb-8 text-[0.95rem]">You’ve unlocked a limited Clozzet Offer Hunt reward from your favorite store.
          Fill in your details and claim it instantly.</p>

        <form onSubmit={handleSubmit}>
          {/* Section 1 */}
          <div className="mb-8 border-b border-gray-100 pb-6">
            <h2 className="text-[#1a1a1a] text-[1.25rem] font-bold mb-1">1️⃣ Select the Store</h2>
            <p className="text-gray-500 text-sm mb-6">Choose the brand where you scanned this QR.</p>
          ...
          {/* Section 2 */}
          <div className="mb-6">
            <h2 className="text-[#1a1a1a] text-[1.25rem] font-bold mb-1">2️⃣ Enter Your Details</h2>
            <p className="text-gray-500 text-sm mb-6">Just your name and number</p>
